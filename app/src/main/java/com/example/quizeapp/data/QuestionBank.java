package com.example.quizeapp.data;
...
import static com.example.quizeapp.controller.AppController.TAG;
...
public class QuestionBank {
    ...
    public List<Question> getQuestion(final AnswerListsyncResponse callBack) {
